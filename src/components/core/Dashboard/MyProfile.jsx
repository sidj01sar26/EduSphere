...
const MyProfile = () => {
  ...
  return (
    <div className=' text-white'>
        ...
        <h2 className=' text-richblack-5 font-medium text-3xl mb-14'>My Profile</h2>
        ...
        {/* SECTION 3 */}
        <div className=' flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12 my-10'>
